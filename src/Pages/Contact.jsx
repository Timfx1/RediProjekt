...
function Contact() {
  ...
  const url1 =
    "https://www.nature.com/srep/calls-for-papers?subject=Medicine&gad_source=1&gclid=CjwKCAjwnqK1BhBvEiwAi7o0X6HXYLeDr1AUJdDAwRq-j9NAQnEaMxBtpJgH0SL8eCkZqbp7UIoLTxoCEn8QAvD_BwE";
        ...
        <div className="parent-container">
          <div className="split-input-wrapper">
            <input
              ...
              placeholder=" Doctor, specialty, practice"
            />
